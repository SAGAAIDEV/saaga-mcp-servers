"""Logging configuration for MCP Gemini MCP server"""
...
from mcp_gemini.config import ServerConfig
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the MCP Gemini MCP server"""
    ...
    project_logger = logging.getLogger("mcp_gemini")
    ...
    log_file = log_path / "mcp_gemini.log"
...
logger = logging.getLogger("mcp_gemini")
